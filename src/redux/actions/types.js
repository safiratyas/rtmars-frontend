...
export const GET_CITIZEN_NOTIFICATION = 'GET_CITIZEN_NOTIFICATION';
export const GET_ADMIN_NOTIFICATION = 'GET_ADMIN_NOTIFICATION';
export const GET_TOTAL_CITIZEN = 'GET_TOTAL_CITIZEN';
export const CREATE_REPORT_DATA = 'CREATE_REPORT_DATA';